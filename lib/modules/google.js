...
//  .apiHost('https://www.google.com/m8/feeds')
  .apiHost('https://www.googleapis.com/plus/v1/people/me')
...
//  .callbackPath('/auth/google/callback')
  ...
  .fetchOAuthUser( function (accessToken) {
    ...
    rest.get('https://www.googleapis.com/plus/v1/people/me', {

//      query: { alt: 'json' },
//      headers: { authorization: 'Bearer ' + accessToken }
      query: { oauth_token: accessToken, alt: 'json' }
    }).on('success', function (data, res) {
      var oauthUser = { id: data.id, displayName: data.displayName };
      console.log('oauthUser %j',oauthUser);
